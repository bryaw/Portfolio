        ...
        >
            <div className=" col-span-8 place-self-center text-center sm:text-left px-28">
                ...
                <div className=" w-11/12">
                    <p className=" text-textslate-300 text-sm sm:text-base lg:text-lg font-medium mt-10 mb-16">
            ...
            <div className=" col-span-4 place-self-center mt-6 sm:pr-48 pr-2 relative">
                <div className=" absolute bg-transparent top-0 -left-28 justify-center items-left">
                    <svg xmlns="http://www.w3.org/2000/svg" width="420px" height="420px" viewBox="0 0 24 24">
                        <g>
                            <circle cx="12" cy="3" r="1" fill="#3E5156">
                            ...
                            <circle cx="16.5" cy="4.21" r="1" fill="#3E5156">
                            ...
                            <circle cx="7.5" cy="4.21" r="1" fill="#3E5156">
                            ...
                            <circle cx="19.79" cy="7.5" r="1" fill="#3E5156">
                            ...
                            <circle cx="4.21" cy="7.5" r="1" fill="#3E5156">
                            ...
                            <circle cx="21" cy="12" r="1" fill="#3E5156">
                            ...
                            <circle cx="3" cy="12" r="1" fill="#3E5156">
                            ...
                            <circle cx="19.79" cy="16.5" r="1" fill="#3E5156">
                            ...
                            <circle cx="4.21" cy="16.5" r="1" fill="#3E5156">
                            ...
                            <circle cx="16.5" cy="19.79" r="1" fill="#3E5156">
                            ...
                            <circle cx="7.5" cy="19.79" r="1" fill="#3E5156">
                            ...
                            <circle cx="12" cy="21" r="1" fill="#3E5156">
